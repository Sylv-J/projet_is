...
class UniteDeCorrection
{
	...
	private $_dateModif = false;// a-t-on corrigÈ/modifiÈ l'UdC ?
	...
	*/
	...
	public function getImage() // RÈcupËre l'image correspondant ‡ l'unitÈ. Si elle n'existe pas, on notifie l'utilisateur par une erreur.
	{
